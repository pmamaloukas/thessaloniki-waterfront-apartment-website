...
<head>
    ...
    <title> Thessaloniki Waterfront Appartment </title>
...
<body>
        <header>
            <a id = "language" href="homepageGreek.php"> GR</a>
        ...
        <main>
            <br><br><br><br><br><br>
            <h1 class = "slogan" id="headSlogan"> <b>Welcome Home!</b> </h1>
            <p class = "slogan"> <b>Sit Back and Enjoy our Traditional Greek Hospitality</b></p>
