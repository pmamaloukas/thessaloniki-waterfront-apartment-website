...
<head>
    ...
    <meta name="description" content="Thessaloniki Waterfront Apartment rent flat cheap city centre book booking">
    ...
    <link rel = "stylesheet" href = "Bookings_css.css">
...
<body>
    <header>
            <a id = "language" href="BookingsGreek.php"> GR</a>
        ...
        <main>
            For bookings you can either visit our listing on Airbnb or Booking.com (see the links at the bottom of the page) or you can send us a booking request through our <a href="Contact.php">contact page.</a>
        </main>
